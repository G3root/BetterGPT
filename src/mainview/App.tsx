  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-500 to-purple-600 text-gray-900">
      <div className="container mx-auto max-w-3xl px-4 py-10">
        <h1 className="mb-2 text-center font-bold text-5xl text-white drop-shadow-lg">
          React + Tailwind + Vite
        </h1>
        <p className="mb-10 text-center text-white/90 text-xl">
          A fast Electrobun app with hot module replacement
        </p>

        <div className="mb-8 rounded-xl bg-white p-8 shadow-xl">
          <h2 className="mb-4 font-semibold text-2xl text-indigo-600">
            Interactive Counter
          </h2>
        ...
        <div className="rounded-xl bg-white p-8 shadow-xl">
          <h2 className="mb-4 font-semibold text-2xl text-indigo-600">Stack</h2>
